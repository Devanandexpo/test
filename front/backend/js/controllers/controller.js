...
myApp.controller('DashboardCtrl', function ($scope, TemplateService, NavigationService, $timeout, $state) {
    ...
    .controller('LoginCtrl', function ($scope,$rootScope, TemplateService, NavigationService, $timeout, $stateParams, $state, toastr,apiService) {
        //Used to name the .html file
        ...
        $scope.login = function(username,password)
        {
            ...
            var formData = {username:username,password:sha256_digest(password)};
